<!--This file must be ina included in all php scripts past, present, and future-->
<html>
    <head>
        <link rel="stylesheet" type="text/css" href="stylesheet.css">
    </head>
<?php
    //Function that builds a view-only HTML table using data from either the apache or AWS server
function sql_to_html_table_view($sqlresult, $delim="\n") {
  ...
  return( $htmltable ) ; 
   ...
   //Function that builds an HTML table for added entries 
function sql_to_html_table_added($sqlresult, $delim="\n") {
  ...
  return( $htmltable ) ; 
    ...
    //Function that builds the main HTML Table for test5.php
    //Includes add, flag for deletion, and delete functions
function sql_to_html_table($sqlresult, $delim="\n") {
  ...
  return( $htmltable ) ; 
    ...
    //Function that builds an HTML table for removed data
function sql_to_html_table_removed($sqlresult, $delim="\n") {
  ...
  return( $htmltable ) ; 
    ...
    //Function that creates a table for editing entries
function sql_to_html_table_edit($sqlresult, $delim="\n") {
  ...
  return( $htmltable ) ; 
    ...
    //Function that creates a form that is used to edit the selected data entry
